...
We’ve been working to make GraphQL natively available in Aura so that you do not need to setup infrastructure to do so.   We are now ready to let people try it out in an Early Access Program that will from 1st April to end of May. 
